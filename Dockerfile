...
MAINTAINER eng-insights <eng-insights@digitalocean.com>
...
RUN curl --insecure -L https://github.com/Yelp/dumb-init/releases/download/v1.2.5/dumb-init_1.2.5_amd64 -o usr/local/bin/dumb-init && chmod +x /usr/local/bin/dumb-init
